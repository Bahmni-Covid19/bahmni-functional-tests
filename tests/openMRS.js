...
step("Verify openmrs prescriptions", async function () {
    var existingPatients = process.env.bahmniHost+ "/openmrs/ws/rest/v1/hip/existingPatients?patientName=First Last&patientYearOfBirth=2000&patientGender=F&phoneNumber=+91-9876543210"
    var prescriptionsVisit = process.env.bahmniHost+ "/openmrs/ws/rest/v1/hip/prescriptions/visit?patientId=fcd4c49a-b4b3-41c1-b5a0-74ef005b6cb2&visitType=OPD&fromDate=2020-01-01&toDate=2021-12-12"
