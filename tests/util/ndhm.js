...
async function interceptAadhaarVerifyOtp() {
    var verifyOtp = fileExtension.parseContent("./data/confirm/aadhaar.txt")
        ...
        .replace('<gender>', gauge.dataStore.scenarioStore.get("patientGender"))
...
async function interceptExistingPatientForAbhaAddress() {
    ...
    //var patienFullName=gauge.dataStore.scenarioStore.get("patientFirstName") + " " + gauge.dataStore.scenarioStore.get("patientMiddleName") + " " + gauge.dataStore.scenarioStore.get("patientLastName")
